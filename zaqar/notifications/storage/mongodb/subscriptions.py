...
from zaqar.notifications.storage import errors
...
_SUBSCRIPTION_CACHE_TTL = 5


def _subscription_exists_key(queue, project=None):
...
class SubscriptionController(storage.Subscription):
    ...
    def list(self, project=None, marker=None,
             limit=storage.DEFAULT_SUBSCRIPTIONS_PER_PAGE, detailed=False):
    ...
    @utils.raises_conn_error
    @utils.retries_on_autoreconnect
    @decorators.caches(_subscription_exists_key, _SUBSCRIPTION_CACHE_TTL, lambda v: v)
